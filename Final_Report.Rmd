...
two key processes in obesity and diabetes.[@david2014diet] A majority of the gut microbiota
...
a healthy microbiota. Recent evidence suggests that a failure to enhance
...
ratio decreases on a low calorie diet with weight loss.[@turnbaugh2009core:1]
...
Next, it removes chimeras and provides a native implementation of the Bayesian classifier method for assigning taxonomy. Finally, this data
