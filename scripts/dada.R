...
#We can see from the quality profiles that most reads tend to get
#pretty bad in quality after around 200 bases.
...
#`r ncol(sequence_table)` columns (sequence variants). Notice how we
#can embed R code directly in our markdown text.
...
#After removing chimeras, we were left with `r non_chimeric_reads`%
#of our cleaned reads.
